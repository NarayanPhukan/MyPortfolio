...
const Navbar = ({isDark, setIsDark}) => {
  ...
  return (
    ...
    <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white/60 backdrop-blur-md shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
        <a href="#top">
        ...
        <div className='flex items-center gap-4'>
            ...
            <a href="#contact" className='hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-ovo dark:border-white/50'>Contact <Image src={isDark? assets.arrow_icon_dark : assets.arrow_icon} className='w-3' alt=''/></a>
